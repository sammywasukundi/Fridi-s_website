...
<div data-dial-init class="fixed flex right-6 bottom-6 group">
    ...
    <button type="button" data-dial-toggle="speed-dial-menu-horizontal" aria-controls="speed-dial-menu-horizontal" aria-expanded="false" class="flex items-center justify-center rounded-full ml-auto text-blue-400 dark:text-white border border-blue-400 w-14 h-14 dark:bg-blue-400 dark:hover:bg-blue-400 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800 hover:shadow-inner transform hover:scale-110 hover:bg-blue-400 transition ease-in duration-500">
        <svg class="w-5 h-5 transition-transform group-hover:rotate-45 hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
