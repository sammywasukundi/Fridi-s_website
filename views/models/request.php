<?php
    ...
    if(isset($_POST['submit_inscription'])){
        if(isset($_POST['nom'],$_POST['password'],$_POST['confirmpassword'])){
            if($_POST['nom'] != '' && $_POST['password'] != '' && $_POST['confirmpassword'] != ''){
                    ...
                    if(isset($_FILES['file']) AND $_FILES['file']['error'] == 0){
                        if($_FILES['file']['size'] < 5000000)
                        {
                            ...
                            if(in_array($recup_extension,$extensions)){
                                ...
                                {
                                    $req = $pdo->prepare("INSERT INTO table_auteur(nom,password,file) VALUES(:nom,:password,:file)");
                                    $req->execute(array(
                                        'nom' => $nom,
                                        'password' => $pass,
