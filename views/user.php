    ...
    <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel" aria-labelledby="stats-tab">
            ...
            <form action="https://marchand.maishapay.online/payment/vers1.0/merchant/checkout" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-6 grid grid-cols-2 justify-center ">
                    <div class="flex pl-0 sm:pl-2 ml-4">
                        <!-- <label for="file" class=" flex mt-4 text-sm font-medium text-gray-900 dark:text-white">Choisir la Photo</label>
                        <div>
                            <label class="rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                <svg class="w-14 h-14 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="flex pl-0 sm:pl-2 ml-4">
                        <!-- <label for="file" class="flex mt-4 text-sm font-medium text-gray-900 dark:text-white">Choisir l'article</label>
                        <div>
                            <label class="space-x-2 rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                <svg class="w-14 h-14 text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 20">
                ...
                <button type="submit" name="submit_books" class="w-full bg-white border border-blue-400 hover:shadow-inner hover:bg-blue-400 hover:text-white px-5 py-2 rounded-md font-semibold dark:bg-blue-300">Soumettre</button>
            </form>
        </div>
