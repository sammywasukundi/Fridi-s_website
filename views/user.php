        ...
        <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="stats" role="tabpanel" aria-labelledby="stats-tab">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Coauteurs</label>
                        <input type="text" id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Flowbite" required>
                    </div>  
                    <div>
                        <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">N° Télephone</label>
                    ...
                    <div>
                            ...
                            <input type="mail" name="send_nom" id="send_nom" placeholder="destinateur@gmail.com" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ex:samBro">
                        </div>
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">A</label>
                            <input type="mail" name="receive_mail" id="receive_mail" placeholder="destnataire@gmail.com" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" oninput="longuer()">
                        </div>
                    <div>
                    ...
                    <div>                       
                        ...
                        <select id="ouvrages" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mb-6">
                    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Titre Du Travail</label>
                ...
                <button type="submit" class="w-full bg-white border border-blue-400 hover:shadow-inner hover:bg-blue-400 hover:text-white px-5 py-2 rounded-md font-semibold dark:bg-blue-300">Soumettre</button>
                ...
                <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                    <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                        <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            Pour accélérer le processus de publication des articles soumis, il est demandé à l'auteur du manuscrit de se conformer strictement aux recommandations ci-dessous. Les recommandations suivantes sont conformes aux normes uniformisées pour la préparation des manuscrits soumis aux CAHIERS DU FRIDI.
                        ...
                        <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            ...
                            Le résumé comprend : (1) une brève introduction (une à deux phrases) qui se clôture par le but de l'étude, (2) la méthodologie comprenant le type d'étude, l'échantillonnage et la taille de l'échantillon avec ses principales caractéristiques, le lieu de collecte et le moment, (3) les principaux résultats en fonction de chaque objectif et (4) une brève conclusion (une à deux
