        ...
        <div id="defaultTabContent">
            ...
            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="statistics" role="tabpanel" aria-labelledby="statistics-tab">
                <form class="space-y-2 md:space-y-6 mx-auto max-w-2xl" action="" method="post">
                    ...
                    <button type="submit"  class="w-full block bg-white border border-blue-400 hover:shadow-inner transform hover:scale-110 hover:bg-blue-400 hover:text-white transition ease-in duration-500 px-5 py-2 rounded-md font-semibold dark:bg-blue-300">Connexion</button>
                </form>
            </div>
        </div>
    </div>
